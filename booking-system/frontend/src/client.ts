...
export function Environment(name: string): BaseURL {
    return `https://${name}-booking-2cv2.encr.app`
}
...
/**
 * Client is an API client for the booking-2cv2 Encore application. 
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "booking-2cv2-Generated-TS-Client (Encore/v1.39.6)";
        }
