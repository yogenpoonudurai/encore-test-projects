...
type UserServiceClient interface {
	Get(context.Context, *connect.Request[v1.UserRequest]) (*connect.Response[v1.UserResponse], error)
}
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		get: connect.NewClient[v1.UserRequest, v1.UserResponse](
			httpClient,
...
type userServiceClient struct {
	get *connect.Client[v1.UserRequest, v1.UserResponse]
}

// Get calls user.v1.UserService.Get.
func (c *userServiceClient) Get(ctx context.Context, req *connect.Request[v1.UserRequest]) (*connect.Response[v1.UserResponse], error) {
...
func (UnimplementedUserServiceHandler) Get(context.Context, *connect.Request[v1.UserRequest]) (*connect.Response[v1.UserResponse], error) {
